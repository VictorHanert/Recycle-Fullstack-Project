  ...
  return (
    <div className="px-4 sm:px-6 md:px-8 lg:px-12">
      ...
      <div className="mb-12 sm:mb-16 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 sm:mb-6">Welcome to ReCycle</h1>
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-6 mb-12">
        <Link to="/products?category=Road+Bikes" className="group">
          <div className="bg-[url('/images/racing-bike.jpg')] bg-cover bg-center bg-no-repeat rounded-xl shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1 border border-gray-100 h-48 md:h-72 relative">
            <div className="absolute inset-0 bg-black bg-opacity-30 rounded-xl flex flex-col justify-start md:justify-end">
              <h3 className="text-lg font-semibold m-3 text-white text-center hidden md:block">Road Bikes</h3>
              <p className="text-xs lg:text-base m-3 text-gray-200 text-center flex-grow hidden md:block">Premium road bikes for speed enthusiasts. From budget-friendly to professional racing bikes.</p>
              <div className="my-3 text-white text-xs md:text-base font-medium text-center group-hover:text-blue-100 sm:whitespace-nowrap">Road Bikes →</div>
            </div>
          </div>
        </Link>
        ...
        <Link to="/products?category=Mountain+Bikes" className="group">
          <div className="bg-[url('/images/mountain-bike.jpg')] bg-cover bg-center bg-no-repeat rounded-xl shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1 border border-gray-100 h-48 md:h-72 relative">
            <div className="absolute inset-0 bg-black bg-opacity-30 rounded-xl flex flex-col justify-start md:justify-end">
              <h3 className="text-lg font-semibold m-3 text-white text-center hidden md:block">Mountain Bikes</h3>
              <p className="text-xs lg:text-base m-3 text-gray-200 text-center flex-grow hidden md:block">Trail-ready mountain bikes for adventure seekers. Full suspension, hardtail, and entry-level options.</p>
              <div className="my-3 text-white text-xs md:text-base font-medium text-center group-hover:text-blue-100 sm:whitespace-nowrap">Mountain Bikes →</div>
            </div>
          </div>
        </Link>
        ...
        <Link to="/products?category=Electric+Bikes" className="group">
          <div className="bg-[url('/images/city-bike.jpg')] bg-cover bg-center bg-no-repeat rounded-xl shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1 border border-gray-100 h-48 md:h-72 relative">
            <div className="absolute inset-0 bg-black bg-opacity-30 rounded-xl flex flex-col justify-start md:justify-end">
              <h3 className="text-lg font-semibold m-3 text-white text-center hidden md:block">City & E-Bikes</h3>
              <p className="text-xs lg:text-base m-3 text-gray-200 text-center flex-grow hidden md:block">Perfect for daily commuting and city rides. Including electric bikes for effortless cycling.</p>
              <div className="my-3 text-white text-xs md:text-base font-medium text-center group-hover:text-blue-100 sm:whitespace-nowrap">City Bikes →</div>
            </div>
          </div>
        </Link>
      </div>
      ...
      <div className="bg-blue-600 rounded-xl p-6 sm:p-8 md:p-10 lg:p-12 text-center text-white">
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4">Ready to Join the ReCycle Community?</h2>
